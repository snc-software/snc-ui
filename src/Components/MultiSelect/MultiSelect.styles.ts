...
export const classes = {
  ...
  trigger: cn(
    baseClasses.base,
    'snc:flex snc:w-full snc:items-center snc:gap-2.5 snc:text-left snc:leading-5',
  ),
  ...
  // `text-ellipsis` never actually get a chance to kick in inside a shrinking flex row.
  ...
  // Delta over Popout's base panel only — row styling itself is delegated to OptionsList/OptionItem.
  panel: cn(
    'snc:overflow-auto',
